 ...
 * (static ↔ static). This suite closes the remaining leg: the LIVE server —
 * what a real MCP client actually receives from tools/list and initialize —
 * must match that same catalog. tools.ts claims it is "kept in lockstep with
